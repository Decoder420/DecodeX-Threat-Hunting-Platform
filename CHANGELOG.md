...
- **Git History Hygiene Runbook**: Authored `docs/GIT_HISTORY_SCRUB_RUNBOOK.md` detailing step-by-step instructions for permanently purging rotated historical secrets (`Manan@123`, legacy ZAP key) across past commit objects using `git-filter-repo`.
